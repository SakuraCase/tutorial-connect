...
func NewElizaServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ElizaServiceClient {
	...
	return &elizaServiceClient{
		say: connect.NewClient[eliza.SayRequest, eliza.SayResponse](
			httpClient,
...
func (c *elizaServiceClient) Say(ctx context.Context, req *connect.Request[eliza.SayRequest]) (*connect.Response[eliza.SayResponse], error) {
...
func (UnimplementedElizaServiceHandler) Say(context.Context, *connect.Request[eliza.SayRequest]) (*connect.Response[eliza.SayResponse], error) {
